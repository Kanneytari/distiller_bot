...
def main_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.button(text="🥃 Мои напитки", callback_data="menu:drinks")
...
def process_list_keyboard(items: Iterable[tuple[int, str]]) -> InlineKeyboardMarkup:
    ...
    builder.button(text="➕ Добавить напиток", callback_data="process:add")
    builder.button(text="🏠 Меню", callback_data="menu:main")
    builder.adjust(1)
    return builder.as_markup()
...
def process_card_keyboard(process_id: int, stage_actions: Iterable[tuple[str, str]]) -> InlineKeyboardMarkup:
    ...
    builder.button(text="⚙️ Параметры", callback_data=f"process:parameters:{process_id}")
