...
def main_menu_text() -> str:
    return (
        "🥃 <b>Distiller Bot</b>\n\n"
        "Помощник домашнего винокура: напитки, рецепты, расчёты и оборудование.\n\n"
        "🥃 <b>Напитки</b> — текущее приготовление и история\n"
        "📖 <b>Рецепты</b> — готовые и свои рецепты\n"
        "🧮 <b>Калькуляторы</b> — расчёты для разных этапов\n"
        "⚙️ <b>Оборудование</b> — сохранённые кубы, ферментеры и другое"
    )
