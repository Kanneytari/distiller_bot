...
## 7. Стиль текстов интерфейса

Во всех пользовательских текстах и экранах бота для тире и текстовых разделителей используется обычный символ `-`.

Unicode em dash (`U+2014`) в пользовательских строках не используется. Это правило действует для новых экранов, подсказок, сообщений, кнопок и текстов калькуляторов.
